...
export const PAGES = [
  { name: 'dashboard',     route: 'home',          url: '/' },
  { name: 'wellness',      route: 'wellness',       url: '/health' },
  { name: 'gym',           route: 'gym',            url: '/gym' },
  { name: 'calisthenics',  route: 'calisthenics',   url: '/skills' },
  { name: 'grind',         route: 'grind',          url: '/grind' },
