...
**NEXUS** — Ibrahim's personal operating system. A zero-dependency, local-first PWA built as a static folder of HTML/CSS/JS pages sharing a unified design system ("Liquid Amethyst").
...
**Bump the service worker cache** — change `CACHE_VERSION` in `sw.js` (currently `nexus-v18`) to force clients to refetch.
