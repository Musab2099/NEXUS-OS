...
(function () {
  ...
  const TOPBAR_SUPABASE_URL = 'https://zschphlqajlojjfwfnhl.supabase.co';
  const TOPBAR_SUPABASE_KEY = 'sb_publishable_rEeeovCIgn6btXHfcKAzXw_7LAoL2F8';
...
@media (max-width: 480px) {
  .topbar {
    ...
    /* Crucial fix: enable smooth horizontal scrolling */
    display: flex;
    flex-wrap: nowrap;
    overflow-x: auto;
  ...
  .topbar-water-pill,
  .topbar-water-wrap {
    /* Prevent the pills from shrinking or compressing to fit the viewport */
    flex: 0 0 auto;
    padding: 7px 12px;
    gap: 5px;
  }
  ...
  .topbar-pill-label {
    display: none; /* Keeps labels hidden on mobile to save space */
  }
